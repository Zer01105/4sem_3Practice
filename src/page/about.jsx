    ...
    <div className="teal lighten-4" style={{ minHeight: '80vh', marginTop: '50px', marginBottom: '50px ' }}>
      <div className="container">
        ...
        <h2 className="center-align teal-text text-darken-2">
          <i className="fas fa-leaf teal-text text-darken-2"></i> About Our Recipe App
        </h2>
            ...
            <div className="card teal lighten-5">
              <div className="card-content">
                <span className="card-title teal-text text-darken-2">
                  <i className="fas fa-heart teal-text text-darken-2"></i> Our Story
                </span>
        ...
        <div className="row" style={{ marginTop: '40px' }}>
          <div className="col s12 m4">
            <div className="card teal lighten-5">
              <div className="card-content center-align">
                <i className="fas fa-utensils fa-3x teal-text text-darken-2" style={{ margin: '15px 0' }}></i>
                <span className="card-title teal-text text-darken-2">Diverse Recipes</span>
                <p>
          ...
          <div className="col s12 m4">
            <div className="card teal lighten-5">
              <div className="card-content center-align">
                <i className="fas fa-users fa-3x teal-text text-darken-2" style={{ margin: '15px 0' }}></i>
                <span className="card-title teal-text text-darken-2">Community Driven</span>
                <p>
          ...
          <div className="col s12 m4">
            <div className="card teal lighten-5">
              <div className="card-content center-align">
                <i className="fas fa-seedling fa-3x teal-text text-darken-2" style={{ margin: '15px 0' }}></i>
                <span className="card-title teal-text text-darken-2">Fresh Approach</span>
                <p>
        ...
        <div className="row" style={{ marginTop: '40px' }}>
          <div className="col s12">
            <div className="card teal lighten-5">
              <div className="card-content">
                <span className="card-title teal-text text-darken-2">
                  <i className="fas fa-award teal-text text-darken-2"></i> Our Team
                </span>
                <div className="row">
                  <div className="col s12 m4 center-align" style={{ padding: '20px' }}>
                    ...
                    />
                    <h5>Chef Maria</h5>
                    <p className="teal-text text-darken-2">Head of Recipe Development</p>
                  ...
                  <div className="col s12 m4 center-align" style={{ padding: '20px' }}>
                    ...
                    />
                    <h5>David</h5>
                    <p className="teal-text text-darken-2">Nutrition Specialist</p>
                  ...
                  <div className="col s12 m4 center-align" style={{ padding: '20px' }}>
                    ...
                    />
                    <h5>Sophie</h5>
                    <p className="teal-text text-darken-2">Community Manager</p>
